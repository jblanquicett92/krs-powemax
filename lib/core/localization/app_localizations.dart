...
class AppLocalizations {
  ...
  static final Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      'ai_download_btn': 'Unlock Offline Coaches (~135MB)',
    ...
    'es': {
      ...
      'ai_download_btn': 'Desbloquear Entrenadores Offline (~135MB)',
    ...
    'pt': {
      ...
      'ai_download_btn': 'Desbloquear Treinadores Offline (~135MB)',

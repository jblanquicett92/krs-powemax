  ...
  static final Map<String, Map<String, String>> _localizedValues = {
    ...
    'es': {
      ...
      'ai_thinking': 'Pensando...',
       'ai_status_active': 'Coaches Activos',
      'ai_status_inactive': 'Coaches Desactivados',
      'ai_download_warning': 'No cierres la app. Se guardará de forma permanente.',
      ...
      'settings_about_desc': 'PowerMax es tu calculadora premium de 1RM y compañero de entrenamiento. Diseñada para optimizar tus levantamientos, seguir tu progreso con rutinas inteligentes y recibir feedback profesional mediante tus entrenadores de Inteligencia Artificial.',
    },
    'pt': {
      'app_title': 'PowerMax 1RM',
      'nav_calculator': 'Calculadora',
